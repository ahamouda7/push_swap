...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/17 23:48:13 by ahamouda          #+#    #+#             */
/*   Updated: 2026/02/17 23:48:13 by ahamouda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap_bonus.h"

static void	push_chunk(t_bs_list **stack_a, t_bs_list **stack_b, int chunk_size)
{
	int		i;
